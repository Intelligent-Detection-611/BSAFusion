...
if modal == 'CT':
    val_dataset = TestData(
        ...
        img1_folder=r'c:\Users\King\Downloads\BSAFusion-main\data\testData\CT\MRI',
        img2_folder=r'c:\Users\King\Downloads\BSAFusion-main\data\testData\CT\CT',
        modal=modal
    )
else:
    val_dataset = TestData(
...
val_dataloader = DataLoader(
    dataset=val_dataset,
    batch_size=1,
    pin_memory=False, #windows下要设置成false
    shuffle=False,
    num_workers=0)#windows下必须设置为0
